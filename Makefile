export IMAGE_NAME?=xirixiz/docker-helloworld-webserver
export APP_VERSION=1.0
export GIT_BRANCH=`git rev-parse --abbrev-ref HEAD`
export VCS_REF=`git rev-parse --short HEAD`
export VCS_URL=https://github.com/xirixiz/docker-helloworld-webserver
export BUILD_DATE=`date -u +"%d-%m-%YT%H:%M:%SZ"`
export TAG_DATE=`date -u +"%d%m%Y"`
export BASE_VERSION=busybox:latest
